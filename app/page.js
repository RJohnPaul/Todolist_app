        ...
        >
          ...
          >
            <div className="flex flex-col gap-y-4 gap-x-0 mt-5 md:flex-row md:items-center md:justify-end md:gap-y-0 md:gap-x-7 md:mt-0 md:ps-7">
              ...
              <a
                className="flex items-center gap-x-2 pt-2 pb-2 font-medium text-gray-500 hover:text-blue-600 md:border-s md:border-gray-300 md:my-6 md:ps-6 dark:border-gray-700 dark:text-gray-400 dark:hover:text-blue-500"
                href="#"
              >
                <svg
            ...
            <div className="flex gap-x-5">
              ...
              <div>
                ...
                <p className="mt-1 text-gray-500">
                  To add tasks to your to-do list, simply tap the 'Add Task' button on
                  the app's main screen and enter the task details.
                </p>
              </div>
            </div>
          </div>
